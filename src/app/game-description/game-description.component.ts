...
export class GameDescriptionComponent implements OnInit, OnChanges {
  cardAction = [
    ...
    { title: '3', description: 'the player who drew the card drinks' },
    { title: '4', description: 'all those who identify as female drink' },
    {
      title: '5 - Thumbmaster',
      description:
    ...
    { title: '6', description: 'all those who identify as male drink.' },
    {
      title: '7 - Heaven',
      description:
  ...
  ngOnChanges(): void {
    if (this.card) {
      // ermittln von Cartennummern, mit .split den string aufteilen und auf die Position 1 zugreifen (0 ist der string)
      let cardNumber = +this.card.split('_')[1];
      // mit this.title auf den Titel mit der Nummer in der Position 1 zugreifen und wiedergeben
      this.title = this.cardAction[cardNumber - 1].title;
      // mit this.description auf die Beschreibung mit der Nummer in der Position 1 zugreifen und wiedergeben
